...
// A Logger writes keys/value pairs to a Handler
type Logger interface {
	...
	// Log logs a message at the specified level with context keys/value pairs
	Log(level slog.Level, msg string, ctx ...interface{})

	// Trace log a message at the trace level with context keys/value pairs
	Trace(msg string, ctx ...interface{})

	// Debug logs a message at the debug level with context keys/value pairs
	Debug(msg string, ctx ...interface{})

	// Info logs a message at the info level with context keys/value pairs
	Info(msg string, ctx ...interface{})

	// Warn logs a message at the warn level with context keys/value pairs
	Warn(msg string, ctx ...interface{})

	// Error logs a message at the error level with context keys/value pairs
	Error(msg string, ctx ...interface{})

	// Crit logs a message at the crit level with context keys/value pairs, and exits
